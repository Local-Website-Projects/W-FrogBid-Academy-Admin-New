 ...
 var dzSparkLine = function(){
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(30, 170, 231, 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(30, 170, 231, 0.5)");
					...
					datasets: [
						{
							...
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(30, 170, 231, 0.5)'
						}
					]
				},
				options: {
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(30, 170, 231, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(30, 170, 231, 0.5)");
